...
function AdminCancelPreorder() {
    const navigate = useNavigate();
        ...
        const getPreOrders = async () => {
            try {
            const { data } = await axios.get(`/api/v1/auth/preorder-preproduct-cancel/${params.preproduct}`);
            setPreorders(data);
            } catch (error) {
            console.log(error);
            }
        ...
        const exporttocsvfunc = async()=>{
            ...
            return await commonrequest("GET",`${BASE_URL}/api/v1/preproduct/preorder-export-cancel/${params.preproduct}`,"");
        }
        ...
        return (
            ...
            <div className="row dashboard">
                ...
                <h1 className="text-center">All Cancel Pre-Orders - {preorders.length}</h1>
...
export default AdminCancelPreorder